...
allow_re='^(bun\.lock|README\.md|RELEASE_CHECKLIST\.md|SPEC_COMPLIANCE\.md|CLAIMS_AUDIT\.md|SHIP_CHECKS/|docs/otto-v01-status\.md|docs/desktop-convergence\.md|receipts/otto-v01/|scripts/verify-v0\.sh)'
