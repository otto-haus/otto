...
export const chatCopy = {
  ...
  headerSetupPill: 'setup',
  subtitleConnecting: 'connecting…',
  ...
  composerPlaceholderConnecting: 'Connecting to Letta…',
  composerAriaLabel: 'Message otto',
  usageLimitHint: ' Switch model or provider in Settings, or wait for the limit to reset.',
  whoYou: 'You',
  whoOtto: 'otto',
