...
export const onboardingCopy = {
  ...
  connectLede: 'Live readiness rows below show the exact blocker. One primary agent — no fleet setup. Provider keys stay in Letta — otto never stores them.',
...
export const settingsCopy = {
  ...
  primaryAgentOpenLetta: 'Open Letta',
  primaryAgentOpenLettaWeb: 'Open Letta web UI',
  primaryAgentOpenLettaDesktop: 'Open Letta Desktop',
  ...
  diagnosticsGroupLede: 'Runtime checks, readiness gates, and export bundles when something looks wrong.',
