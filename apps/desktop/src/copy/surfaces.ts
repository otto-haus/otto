...
export const chatCopy = {
  ...
  composerHintTab: 'Tab to send · Enter for a new line',
  composerHintEnter: 'Enter to send · Shift+Enter for a new line',
  composerNotReadyHint: 'Finish setup above to send · your draft is saved locally',
  composerPlaceholderReady: 'Message otto…',
  composerPlaceholderBusy: 'Steer this reply…',
  composerPlaceholderDraftWhileSetup: 'Draft while setup finishes…',
  composerPlaceholderUsageLimit:
    'Usage limit reached — switch model/provider in Settings or wait for reset',
  composerAriaLabel: 'Message otto',
...
export const previewCopy = {
  ...
  enterFullscreenHint: 'Expand artifact to fullscreen (⌘⇧F)',
  exitFullscreenHint: 'Return to split preview pane (⌘⇧F or Esc)',
  fullscreenLabel: 'Fullscreen artifact preview',
...
export const settingsCopy = {
  ...
  providerApiKeyPresent: 'Provider auth on file in Letta',
  providerApiKeyMissing: 'No provider auth on file in Letta',
  providerKeysInLettaHint: 'Add or rotate provider keys in Letta — use Open Letta above, or connect BYOK providers below.',
  byokConnectTitle: 'Connect BYOK providers',
  byokConnectLede: 'Write-only handoff to Letta. Keys are never stored or shown again in otto.',
  byokConnectSubmit: 'Connect',
  byokConnectBusy: 'Connecting…',
  byokConnectBaseUrlLabel: 'Base URL',
  byokConnectApiKeyLabel: 'API key',
  byokConnectOpenRouterHint: 'OpenRouter API key — billed by OpenRouter.',
  byokConnectOllamaHint: 'Local Ollama OpenAI-compatible endpoint.',
  byokConnectLmStudioHint: 'LM Studio local OpenAI-compatible server.',
  byokConnectCustomHint: 'Custom OpenAI-compatible gateway (vLLM, corporate proxy, etc.).',
  byokConnectStatusConnected: 'connected',
  byokConnectStatusMissing: 'not connected',
  byokConnectStatusError: 'error',
  byokConnectModelsAfter: (count: number) => `${count} model handle${count === 1 ? '' : 's'} in Letta catalog`,
  ...
  diagnosticsGroupLede: 'Runtime checks, readiness gates, logs, and export bundles when something looks wrong. Use Cmd+Q for normal quit; Safe reset when Chat is blank, frozen, or queue items are stuck after a force-quit.',
  ...
  safeResetBusy: 'Resetting…',
  safeResetPreserves: 'Preserves: ~/.otto config, chat threads, receipts, standards, and Letta agent memory.',
  safeResetClears: 'Clears: in-flight turns, unsent queue, session tool allowances, and hung transport listeners.',
  safeResetDoneTitle: 'Safe reset complete',
  ...
  gracefulQuitTitle: 'Normal quit vs Safe reset',
  gracefulQuitBody: 'Use Cmd+Q (or otto → Quit) for everyday shutdown — otto stops the runtime and clears the session marker. Use Safe reset when you force-quit, the Mac sleeps mid-turn, or Chat/queue looks stuck after relaunch.',
  safeResetDirtyAction: 'Run Safe reset now',
  systemHealthSafeReset: 'Safe reset…',
  ...
  dreamingEmptyMemfsTitle: 'MemFS required',
  dreamingEmptyMemfsBody: 'Sleep-time reflection needs the memory filesystem (memfs). Enable OTTO_MEMFS=1 when your backend supports it, then reconnect.',
  dreamingEmptyNotLoadedTitle: 'Dream settings unavailable',
  dreamingEmptyNotLoadedBody: 'Connect Letta and wait for the runtime before changing sleep-time reflection.',
  dreamingLoading: 'Loading dream settings…',
