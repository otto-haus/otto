...
export const settingsCopy = {
  ...
  diagnosticsLede: 'Export a redacted bundle, open log folders, or tail recent runtime output when chat or transport misbehaves.',
  ...
  diagnosticsOpenRuns: 'Open trace folder (~/.otto/runs)',
  diagnosticsRefreshLogs: 'Refresh log tail',
  diagnosticsCopyLogPath: 'Copy log path',
  diagnosticsCopyLogPathDone: 'Log path copied',
  diagnosticsLogsTitle: 'Recent logs (redacted)',
  diagnosticsLogsEmpty: 'No log files yet. Send a chat turn or restart otto, then refresh.',
  diagnosticsLogsFolder: 'Logs folder',
  diagnosticsRunsFolder: 'Trace folder',
  diagnosticsDevToolsHint: 'DevTools: ⌥⌘I (macOS) or View → Toggle Developer Tools. Console: await window.otto.diagnostics.export()',
