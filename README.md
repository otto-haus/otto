...
auto-discovery. Running it before that point exits with a missing-agent message instead
of performing a fake smoke. If Letta is installed outside the default macOS app path, set
