...
- **After (tick 025 branch):** pending push on `cursor/unified-shipping-loop-orchestrator-0dd5`

## Notes

Fix applied on orchestrator tick 025 branch (not pushed to foreign dependabot branch — Worker charter rule). Sebastian should cherry-pick sdk+audit fix into #921 or prefer #905 + tick 025 stack once CI confirms green.
