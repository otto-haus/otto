...
export const features: Feature[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      L("rule"),
      L("out", "workspace surfaces (left rail):"),
      L("file", "Chat · Charters · Standards · Practices"),
      L("file", "Routines · Curation · Receipts · Autonomy"),
      L("out", "Chat is primary; a one-way-door approval renders as the 'ink moment'"),
      L("out", "Settings → readiness: runtime · agent · model · skills · MCPs · functions"),
      L("gate", "Setup required — chat disabled until the runtime is wired"),
      L("dim", "preview — file-backed panes; nothing wired to a live runtime in v0.1"),
    ],
    status: { built: true, tested: "build", tried: false, approved: false },
    proves: "A real workspace shell: sidebar surfaces, chat-primary, file-backed panes.",
  },
  {
    id: "OttoV01Knowledge",
